...
export declare function aggregateErrors(errors: unknown[], message?: string): Error | AggregateError;
/**
...
export declare const dedupeStrs: <T extends string>(strs: Iterable<T>) => T[];
